...
const whyUs =
{
    customer_satisfiction: ['High customer retention score exceeding 95%', 'Most Preferred IFM operator for Royal Properties and Iconic projects', 'Strategic alignment with our customers’ facility objective'],
    bestInClass: ['Established processes (i.e. root cause analysis and reliability centered maintenance) Continuous improvement of processes leading to reduced cost. Continuous performance measurement to ensure quality value and customer satisfaction', 'ISO 9001, 14001 & OHSAS 18001 certified', 'ERP based Material Management, Service delivery system'],
    specilizedWork: ['Multi cultural, highly motivated, young  workforce of 3500+ people', 'Omanisation levels of 18%']
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-y-5 gap-x-0 lg:gap-5 pt-5">
            <div className="relative p-5">
                <div className="p-10 lg:p-7 xl:p-10 border-dashed border border-slate-400">
                    <h3 className="text-lg font-bold text-black uppercase">CUSTOMER SATISFACTION</h3>
                    <ul className="my-5">
                        {
