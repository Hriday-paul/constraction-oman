              ...
              <div className="conta flex flex-col md:flex-row gap-8 lg:flex-row justify-around py-14 place-items-center">
                  <div className="box flex flex-col justify-center place-items-center">
                      ...
                      <div className="desc text-center">
                          <p className='text-slate-500 capitalize'>{contactInfo?.country}</p>
                          <p className='text-slate-500'>{contactInfo?.address}</p>
                          <p className='text-slate-500'>Postal code : {contactInfo?.post_code}</p>
                  ...
                  <div className="box flex flex-col justify-center place-items-center">
                      ...
                      <div className="desc text-center">
                          <p className='text-slate-500'>Toll freee : {contactInfo?.toll_free}</p>
                          <p className='text-slate-500'>Telephone : + {contactInfo?.telephone}</p>
                          <p className='text-slate-500'>Fax : + {contactInfo?.fax}</p>
                          <p className='text-sm flex place-items-center gap-2 text-secondary justify-center'>Map <IoIosArrowRoundForward /></p>
                      </div>
                  </div>
                  <div className="box flex flex-col justify-center place-items-center">
